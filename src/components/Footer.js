		...
		<footer>
			<ul>
				<li>
					<a
						className="footer"
						href="https://github.com/KVance1010"
						target="_blank"
					>
						<svg
				...
				<li>
					<a
						className="footer"
						href="www.linkedin.com/in/kyle-s-vance"
						target="_blank"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
              className='svgLinkedIn'
							preserveAspectRatio="xMidYMid meet"
							viewBox="0 0 256 256"
              fill="#f0f8ff"
						>
				...
				<li><a className ="footer medium"  href= "https://medium.com/@vanceofalifetime" target="_blank">M</a></li>
			</ul>
		</footer>
	);
}
